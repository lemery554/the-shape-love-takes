...
- [x] **TWI-007 | P0 | Decide exact journal contents**: The journal includes Brooke's childhood copy of the full-name letter (practiced in her own hand) and a private entry explaining that mediated distance feels safer to Brooke than closeness. Clarified (2026-08-13, skeptical-reader audit #29): the *original* signed envelope is kept separately with the adoption papers in the keepsake box, not inside the journal, so it survives the journal theft and Brooke retains it after Chapter 20. Anna reads both the original letter and the journal during the house entries; only the journal is taken.
